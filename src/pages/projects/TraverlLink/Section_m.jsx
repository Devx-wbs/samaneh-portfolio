...
//         {/* Images */}
//         <div className="flex justify-center md:justify-end gap-8 relative items-center">
//           {/* Soft blurred shadow behind both images */}
//           <div className="absolute -top-14 left-10 w-[360px] h-[260px] rounded-3xl bg-gradient-to-tr from-[#6B4EFF]/20 via-transparent to-transparent filter blur-3xl pointer-events-none"></div>

//           {/* Desktop Image Container with subtle 3D tilt and float */}
//           <motion.div
//             initial={{ rotateY: -10, y: 10, opacity: 0 }}
//             whileInView={{ rotateY: 0, y: 0, opacity: 1 }}
//             viewport={{ once: false }}  // <-- Changed here
//             transition={{ duration: 0.7, ease: "easeOut" }}
//             className="relative rounded-3xl shadow-xl max-w-[320px]"
...
//           {/* Apple Watch with glow ring and float */}
//           <motion.div
...
//               alt="Apple Watch"
//               className="rounded-2xl shadow-md w-28 object-contain"
//               draggable={false}
//             />
//           </motion.div>
//         </div>
