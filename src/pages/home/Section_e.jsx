...
const Section_e = () => {
  return (
    <div className="min-h-96 bg-[#f4f1ec] flex items-center justify-center px-4 ">
      <div className="flex flex-col md:flex-row items-center   gap-8 max-w-7xl w-full">

        <div className="relative w-full md:w-2/4 rounded-md overflow-hidden flex flex-col items-center justify-center text-center px-6 py-16 bg-cover bg-center" style={{ backgroundImage: "url('https://images.squarespace-cdn.com/content/v1/657a22e2f7e9cd0df1d35893/df350a30-81c7-46bc-a0f4-340cf6590c8b/6454a11ecd601a2264d2bb48_Group+2.png?format=2500w')" }}>
          
          <div className="relative z-10">
            <h1 className="text-[#3d332a] text-xl sm:text-2xl font-bold">UXLERATOR</h1>
        ...
        <div className="w-full md:w-[300px] bg-[#55b197] text-white p-6 sm:p-8 rounded-md text-center md:text-left flex flex-col justify-between h-96">
          <div>
            ...
            <p className="text-sm sm:text-base mb-10 leading-relaxed">
              A mobile app for UX job seekers to connect with experienced mentors, seek career guidance and establish networks.
            </p>
          </div>
