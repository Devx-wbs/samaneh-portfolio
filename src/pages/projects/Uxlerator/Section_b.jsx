...
const Section_b = () => {
  ...
  return (
    <section className="bg-[#f7f3e9] w-full sm:py-20 py-8 px-4 relative overflow-hidden">
      <div
        ref={ref}
        className="max-w-7xl mx-auto relative z-10 bg-white rounded-xl shadow-2xl p-10 overflow-hidden"
      >
        {/* Heading */}
        <motion.h2
