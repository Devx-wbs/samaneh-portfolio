  ...
  return (
    <section className="bg-[#f8f5ec] w-full pb-[70px] pt-[80px] px-2">
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-md shadow-md p-6 flex flex-col items-center">
        ...
        <div>
          <img
            src="/project_a_img_d.png" // <-- Replace with your image path
            alt="Keysight PWMA"
        ...
        <div>
          <img
            src="/project_a_img_e.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <p className="mb-6 text-[18px] md:text-[22px] text-left w-full">
          ...
          <ul className="list-disc pl-6 mt-4 ms-8">
            ...
            <li>
              ...
              PWMA, education background, and role within the company.
            </li>
          </ul>
        </p>
        ...
        <div>
          <img
            src="/project_a_img_f.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_g.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_h.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_i.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_j.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_k.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_l.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_m.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_n.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_o.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_p.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_q.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_r.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
        ...
        <div>
          <img
            src="/project_a_img_s.png" // <-- Replace with your image path
            alt="Keysight PWMA"
            className="md:max-w-[930px] max-w-full mx-auto my-10 rounded"
            style={{ objectFit: "contain" }}
          />
