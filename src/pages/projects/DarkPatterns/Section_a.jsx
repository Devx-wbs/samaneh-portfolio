        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="flex items-start gap-4 pt-10">
              <div className="w-1 h-14 bg-blue-500 rounded-sm"></div>
              <h1
                className="text-[40px] sm:text-[48px] font-extrabold leading-tight tracking-tight"
            ...
            <p
              className="mt-6 text-[20px] sm:text-[24px] font-extrabold leading-snug text-[#333333]"
          ...
          <div className="mt-16 grid gap-10 sm:grid-cols-2">
            ...
            >
              ...
              <h2
                className="text-[28px] font-extrabold text-blue-600 mb-4"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
                TEAM
              </h2>
              <ul
                className="text-[18px] text-[#444] font-medium space-y-1"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
                <li>KRISTINA</li>
                <li>LAPIRA</li>
