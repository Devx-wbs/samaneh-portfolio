...
//           className="text-charcoal hover:text-accent-teal transition-colors duration-300 bg-transparent shadow-none p-0 m-0 rounded-none"
//         >
...
//               exit={{ y: -20, opacity: 0 }}
//               transition={{ duration: 0.3 }}
//               className="absolute top-full left-0 w-full bg-white border-t border-neutral-200 shadow-md rounded-b-2xl z-40 md:hidden"
//             >
